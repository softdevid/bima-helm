        ...
        <div class="col-sm-10">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <input type="number" value="0" class="form-control" name="s" value="{{ old('s') }}">
                </div>
                <div class="col">
                    <label for="size" class="col-sm-2 col-form-label">M</label>
                    <input type="number" value="0" class="form-control" name="m" value="{{ old('m') }}">
                </div>
                <div class="col">
                    <label for="size" class="col-sm-2 col-form-label">LG</label>
                    <input type="number" value="0" class="form-control" name="lg" value="{{ old('lg') }}">
                </div>
                <div class="col">
                    <label for="size" class="col-sm-2 col-form-label">XL</label>
                    <input type="number" value="0" class="form-control" name="xl" value="{{ old('xl') }}">
                </div>
                <div class="col">
                    <label for="size" class="col-sm-2 col-form-label">XXL</label>
                    <input type="number" value="0" class="form-control" name="xxl" value="{{ old('xxl') }}">
                </div>
            </div>
        </div>
    </div>
