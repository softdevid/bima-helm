    ...
    <div class="mb-5">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 mt-2">
            <a href="javascript:void(0)">
                <div class="col">
                    <div class="card h-100">
                        <img src="/img/helm/KYT-C5-IANONE-WHITE.jpeg" class="card-img-top" alt="...">
            ...
            <a href="javascript:void(0)">
                <div class="col">
                    <div class="card h-100">
                        <img src="/img//helm/KYT-RC-SEVEN-17-BLACK-DOFT-GOLD.jpeg" class="card-img-top" alt="...">
                        <div class="card-img-overlay d-flex align-items-end p-0">
                            <h5 class="card-title text-center text-white flex-fill p-2 mb-0"
            ...
            <a href="javascript:void(0)">
                <div class="col">
                    <div class="card h-100">
                        <img src="/img/helm/kyt-tt-course-plain-mat-black.jpeg" class="card-img-top" alt="...">
                        <div class="card-img-overlay d-flex align-items-end p-0">
                            <h5 class="card-title text-center text-white flex-fill p-2 mb-0"
