...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link {{ $title === 'Kasir' ? 'active text-white fade-in' : '' }}"
                    href="{{ route('kasir-input.index') }}">
                    <i class="fa-solid fa-ballot-check {{ $title === 'Kasir' ? 'active text-white fade-in' : '' }}"></i>
                    <span>Kasir</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Pilih "Logout" jika kamu ingin keluar dari kasir</div>
