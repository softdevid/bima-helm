    ...
    <!-- title row -->
        <div class="row">
          <div class="col-12">
            <h2>
              ...
              <small class="float-right">Laporan Tahun: {{ $date_tahun }}</small>
            </h2>
          </div>
          <!-- /.col -->
        </div>
        ...
        <div class="row invoice-info">
          ...
          <div class="col-sm-4 invoice-col">
            ...
            <b>Waktu Laporan:</b> {{ $date_tahun }}<br>          
          </div>
          <!-- /.col -->
        </div>
        <!-- /.row -->
        ...
        <div class="row">
          ...
          <!-- /.col -->
            ...
            <div class="row no-print" id="hide">
              <div class="col-12">
                <a onclick="window.print()" class="btn btn-primary print"><i class="fas fa-print" id="hide"></i> Print</a>
                <a href="{{ route('laporan.index') }}" class="btn btn-secondary"><i class="fa fa-circle-left" id="hide"></i> Kembali</a>
              </div>
            </div>
          </div>
          <!-- /.invoice -->
