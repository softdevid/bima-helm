            ...
            <tbody>
                @foreach ($products as $key => $products)
                    <tr>
                        ...
                        <td>
                            <button type="submit" class="btn btn-success" title="Laporkan penjualan Produk ini"
                                data-bs-toggle="modal" data-bs-target="#exampleModal">Laporkan</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-3">
                                        <li>XS: {{ $products->size->xs }}</li>
                                        <li>S: {{ $products->size->s }}</li>
                                        <li>M: {{ $products->size->m }}</li>
                                    </div>
                                    <div class="col-lg-3">
                                        <li>LG: {{ $products->size->lg }}</li>
                                        <li>XL: {{ $products->size->xl }}</li>
                                        <li>XXL: {{ $products->size->xxl }}</li>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <p>
                                        <select class="form-control form-select" name="size_name" required>
                                            ...
                                            @foreach ($size_name as $size_name)
                                                <option value="{{ $size_name->id }}">{{ $size_name->name }} =
                                                    {{ $products->size }}</option>
                                            @endforeach
                                        </select>
                                    </p>
                                    <p>
